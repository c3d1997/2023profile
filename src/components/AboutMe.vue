<template>
  <Container :width="600" :mg-bottom="30">
    ...
    <div class="aboutMe">
      <h3>關於我</h3>
      <p>
        我是名熱情的跨領域轉職者，現在專注於前端開發領域，擁有一年的實務經驗。我的轉職之旅始於對技術的強烈興趣，這驅使我在利用業餘時間學習中迅速掌握了前端開發的核心技術，包括
        HTML5、CSS3 和
        JavaScript。我對高質量網站開發的專注不僅限於現有技術，目前正在積極自學
        Vue3 框架並探索其他編程語言和框架，以豐富我的技術棧和視野。
      </p>
      <p>
